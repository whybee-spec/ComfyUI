        ...
        async def post_prompt(request):
            ...
            if "prompt" in json_data:
                ...
                if valid[0]:
                    ...
                    with open(f"/home/comfyui/user_pools/{self.user_id}/workflows/workflow_api.json", "w") as json_file:
                        json.dump(prompt, json_file, indent=4)
                    if "extra_data" in json_data:
                        with open(f"/home/comfyui/user_pools/{self.user_id}/workflows/workflow.json", "w") as json_file:
                            json.dump(extra_data['extra_pnginfo']['workflow'], json_file, indent=4)
